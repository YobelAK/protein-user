  ...
  try {
    ...
    const prPayload = {
      ...
      channel_properties: {
        ...
        skip_three_ds: false,
        failure_return_url: origin ? `${origin}/fastboat/book/payment?status=failed` : undefined,
        success_return_url: origin ? `${origin}/fastboat/book/payment?status=success` : undefined,
      },
